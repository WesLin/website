...
<%
	...
	<div class="block_basic_main_ope_area">
		<input type="button" value="添加课程" onclick="location.href='/course/add.htm';" />
	</div>
<%}%>
	...
	<div class="block_basic_main_list">
		<div class="block_basic_main_list_detail_unit" >
			...
			<span class="block_basic_main_list_detail_content">
				<span class="block_lesson_list_detail_content_title">斗鱼直播课堂<cite>授课教师：张三&nbsp;&nbsp;李四</cite></span>
			...
			<span class="block_basic_main_list_detail_ope">
				<input type="button"  value="查看详情" onclick="location.href='/test/course-info.htm';" />
			</span>
		</div>
	</div>
