...
<%@page import="com.metaedu.server.website.web.common.AddressConfig"%>
<%@ page language="java" pageEncoding="UTF-8"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<%
UserSummary curUserSummaryLive = (UserSummary)request.getAttribute("summary");
String curLessonIdRecord = (String)request.getAttribute("lessonId");
%>
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			var flashvars = {
				isRecord : true,
				conversationId : "<%=curLessonIdRecord%>",
				streamAddress : "<%=(String)AddressConfig.getContext().getBean("StreamServer")%>",
				fileDownloadAddress : "<%=(String)AddressConfig.getContext().getBean("FileDownloadAddress")%>",
				recordUrl : "<%=(String)AddressConfig.getContext().getBean("RecordDataServer")%>"
			};
			var params = {};
			params.quality = "high";
